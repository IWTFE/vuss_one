    ...
    <div class="layer-init border-box"> 
       <el-form :inline="true" :model="form" class="demo-form-inline" label-width="100px">
         ...
         <el-form-item label="身份证号">
           <el-input v-model="form.idCardNo" placeholder="身份证号"></el-input>
         </el-form-item>
         ...
         <el-form-item label="玩法名称">
           <el-input v-model="form.gameName" placeholder="玩法名称"></el-input>
         </el-form-item>
         <el-form-item label="期号">
           <el-input v-model="form.issueNumber" placeholder="期号"></el-input>
         </el-form-item>
      ...
      return {
        ...
        tradingState_: [{
         ...
         tableData: [{
          ...
          orderId: '20101021002',
          tradingTime: '5896545698200',
          tradingSystem: '623555151244514',
          dealerName: '2017-3-1 16:18:29',
          betUserId: '1231123541221',
          gameName: '2123121',
          issueNumber: '55434545654',
          accountId: '100.00',
          betCount: '5',
          tradingAmount: '预缴款',
          tradingState: '渠道商A',
